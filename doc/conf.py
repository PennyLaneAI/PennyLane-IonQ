...
# -*- coding: utf-8 -*-
#
# PennyLane-IonQ documentation build configuration file.
#
...
html_theme_options = {
    ...
    "project_nav_name": "PennyLane-IonQ",
...
from directives import CustomDeviceGalleryItemDirective, UsageDetails
